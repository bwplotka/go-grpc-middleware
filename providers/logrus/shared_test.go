...
import (
	...
	"github.com/grpc-ecosystem/go-grpc-middleware/providers/logrus/ctxlogrus"
...
func (s *loggingPingService) PingList(ping *pb_testproto.PingRequest, stream pb_testproto.TestService_PingListServer) error {
	ctxtags.Extract(stream.Context()).Set("custom_tags.string", "something").Set("custom_tags.int", 1337)
