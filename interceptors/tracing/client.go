...
func (o *opentracingClientReportable) ClientReporter(ctx context.Context, _ interface{}, typ interceptors.GRPCType, service string, method string) (interceptors.Reporter, context.Context) {
	...
	newCtx, clientSpan := newClientSpanFromContext(ctx, o.tracer, fmt.Sprintf("/%s/%s", service, method))
...
func UnaryClientInterceptor(opts ...Option) grpc.UnaryClientInterceptor {
	...
	inner := interceptors.UnaryClientInterceptor(&opentracingClientReportable{tracer: o.tracer, filterOutFunc: o.filterOutFunc})

	return func(parentCtx context.Context, method string, req, reply interface{}, cc *grpc.ClientConn, invoker grpc.UnaryInvoker, opts ...grpc.CallOption) error {

		return inner(parentCtx, method, req, reply, cc, invoker, opts...)
	}
}
...
func StreamClientInterceptor(opts ...Option) grpc.StreamClientInterceptor {
	o := evaluateOptions(opts)
	inner := interceptors.StreamClientInterceptor(&opentracingClientReportable{tracer: o.tracer})
	...
	return func(parentCtx context.Context, desc *grpc.StreamDesc, cc *grpc.ClientConn, method string, streamer grpc.Streamer, opts ...grpc.CallOption) (grpc.ClientStream, error) {
		...
		return inner(parentCtx, desc, cc, method, streamer, opts...)
	}
}
